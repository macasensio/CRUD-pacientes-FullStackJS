                        ...
                        <div className="my-3">
                            ...
                            <input
                                ...
                                onChange={e => setPerfil({
                                    ...perfil, //toma una copia del objeto existente
                                    [e.target.name] : e.target.value //solo modifica la propiedad que le indico. y modifica el perfil, no el auth original
                                })}
                            />
                        </div>
